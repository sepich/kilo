...
Flags:
  ...
  -h, --help                           help for kg
      ...
      --mesh-granularity string        The granularity of the network mesh to create. Possible values: location, full, subnet (default "location")
      ...
      --route-internal-ip              Route internal traffic through WireGuard (default true)
